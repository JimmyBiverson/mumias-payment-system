                    ...
                    <div class="navbar-nav ml-auto d-flex align-items-center">
                      <?php if(isset($_SESSION['userdata']['id']) && $_settings->userdata('type') == 2): ?>
                        <a href="./?page=update_account" class="text-light  nav-link"><b> Hi, <?php echo $_settings->userdata('firstname')?>!</b></a>
                            ...
                            <button id="install-app" class="btn btn-success btn-sm ml-2 d-none d-md-inline-block"><i class="fa fa-download"></i> Download App</button>
                            <a id="download-apk" class="btn btn-info btn-sm ml-2 d-md-none" href="<?php echo base_url ?>inc/mmspyt.biz.apk" download><i class="fa fa-android"></i> APK</a>
                        <?php else: ?>
