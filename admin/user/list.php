				...
				<tbody>
					...
					?>
						<tr>
							...
							<td data-label="Username"><p class="m-0 truncate-1"><?php echo $row['username'] ?></p></td>
							<td align="center" data-label="Action">
                                <a class="btn btn-sm btn-glass" href="?page=user/manage_user&id=<?php echo $row['id'] ?>" title="Edit"><i class="fa fa-edit text-primary"></i></a>
                                <a class="btn btn-sm btn-glass delete_data ml-1" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" title="Delete"><i class="fa fa-trash text-danger"></i></a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
