...
<?php 
 ...
 $qry = $conn->query("SELECT t.*, c.name as company, pg.name as gateway_name FROM `transaction_list` t 
     LEFT JOIN company_list c ON c.id = t.company_id 
            ...
            <fieldset>
                ...
                <div class="col-12">
                    <dl>
                        ...
                        <dt class="text-info">Payment Gateway:</dt>
                        <dd class="pl-3"><?php echo isset($gateway_name) ? $gateway_name : 'N/A' ?></dd>
