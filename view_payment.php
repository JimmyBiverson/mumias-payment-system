...
<?php 
 ...
 $qry = $conn->query("SELECT t.*,c.name as company from `transaction_list` t inner join company_list c on t.company_id = c.id where t.id = '{$id}' ");
            ...
            <fieldset>
                ...
                <div class="col-12">
                    <dl>
                        ...
                        <dt class="text-info">Payment Code:</dt>
